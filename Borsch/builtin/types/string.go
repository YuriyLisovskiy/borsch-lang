...
var StringType = ObjectType.NewType(
	"рядок",
...
// Type of this object
func (value String) Type() *Type {
	return StringType
}

func StrNew(cls *Type, args Tuple, kwargs StringDict) (Object, error) {
	var (
		sObj     Object = String("")
		encoding Object
		errors   Object
	...
	err := ParseTupleAndKeywords(
		...
		kwargs,
		"|OOO:str",
		[]string{"байти_або_буфер", "кодування", "помилки"},
		&sObj,
		&encoding,
		&errors,
	)
...
func (value String) Intern() String {
...
func (value String) __repr__() (Object, error) {
...
func (value String) __contains__(item Object) (Object, error) {
	...
	if !ok {
		return nil, ErrorNewf(TypeError, "'in <string>' requires string as left operand, not %s", item.Type().Name)
	}
