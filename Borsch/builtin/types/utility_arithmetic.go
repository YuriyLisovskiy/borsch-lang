...
func Negate(a Object) (Object, error) {
	...
	return nil, ErrorNewf(TypeError, "непідтримуваний тип операнда для -: '%s'", a.Class().Name)
}
...
func MakeInt(a Object) (Object, error) {
	...
	return nil, ErrorNewf(TypeError, "непідтримуваний тип операнда для int: '%s'", a.Class().Name)
}
...
func MakeReal(a Object) (Object, error) {
	...
	return nil, ErrorNewf(TypeError, "непідтримуваний тип операнда для real: '%s'", a.Class().Name)
}
...
//
// If c != NilClass then it won't attempt to call __reversed_pow__
//
...
func Pow(a, b, c Object) (Object, error) {
	...
	if c == NilTypeClass && a.Class() != b.Class() {
