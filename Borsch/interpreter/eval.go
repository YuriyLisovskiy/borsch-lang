...
func (node *Comparison) Evaluate(state common.State, valueToSet types.Object) (types.Object, error) {
	...
	case ">":
		return evalBinaryOperator(state, valueToSet, node.BitwiseOr, node.Next, types.Greater)
	case "<=":
		return evalBinaryOperator(state, valueToSet, node.BitwiseOr, node.Next, types.LessOrEqual)
	case "<":
		return evalBinaryOperator(state, valueToSet, node.BitwiseOr, node.Next, types.LessThan)
	case "==":
		return evalBinaryOperator(state, valueToSet, node.BitwiseOr, node.Next, types.Equal)
	case "!=":
		return evalBinaryOperator(state, valueToSet, node.BitwiseOr, node.Next, types.NotEqual)
	default:
...
func (node *BitwiseShift) Evaluate(state common.State, valueToSet types.Object) (types.Object, error) {
	...
	case ">>":
		return evalBinaryOperator(state, valueToSet, node.Addition, node.Next, types.RightShift)
	default:
...
func (node *Addition) Evaluate(state common.State, valueToSet types.Object) (types.Object, error) {
	...
	case "-":
		return evalBinaryOperator(state, valueToSet, node.MultiplicationOrMod, node.Next, types.Subtract)
	default:
...
func (node *MultiplicationOrMod) Evaluate(state common.State, valueToSet types.Object) (types.Object, error) {
	...
	case "*":
		return evalBinaryOperator(state, valueToSet, node.Unary, node.Next, types.Multiply)
	case "%":
		return evalBinaryOperator(state, valueToSet, node.Unary, node.Next, types.Mod)
	default:
...
func (node *Unary) Evaluate(state common.State, valueToSet types.Object) (types.Object, error) {
	...
	case "-":
		return evalUnaryOperator(state, node.Next, types.Negate)
	case "~":
		return evalUnaryOperator(state, node.Next, types.Invert)
	default:
...
func (node *Exponent) Evaluate(state common.State, valueToSet types.Object) (types.Object, error) {
	return evalBinaryOperator(
		...
		func(left, right types.Object) (types.Object, error) {
			return types.Pow(left, right, types.NilTypeClass)
		},
	)
}
...
func (node *Literal) Evaluate(state common.State) (types.Object, error) {
	...
	if node.Dictionary != nil {
		dict := types.NewStringDictSized(len(node.Dictionary))
	...
	if node.EmptyDictionary {
		return types.NewStringDict(), nil
	}
